...
//				distance += abs(
//						trains[train_row].vector[k] - tests[t_row].vector[k]);//city-block距离
			...
			tests[t_row].dis[train_row] = distance+const_var;
		}
	}
}
